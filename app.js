...
// Todo: Extract Text from text area and store int to an Array
// Todo: Render the names extracted from text area
// Todo: Pick A Random Winner, remove HOM/Her From tge Banes Array
// Todo: Display Winners Name

}

function createListTItem(name){
